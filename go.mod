...
require (
	...
	github.com/open-policy-agent/eopa v1.44.0
...
require (
	...
	github.com/open-policy-agent/opa-envoy-plugin v1.9.0-envoy // indirect
	github.com/open-policy-agent/regal v0.36.1 // indirect
